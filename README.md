...
* AWS EC2 Ubuntu Web Server (Apache Deployment) - This project showcase the deployment of a web server on AWS EC2 using Ubuntu and Apache, including network configuration and basic cloud infrastructure setup.
